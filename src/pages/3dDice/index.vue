<template>
  ...
  <div
    class="relative h-[calc(100vh-132px)] w-full overflow-hidden bg-[radial-gradient(circle,_#2c3e50_0%,_#000000_100%)]"
  >
    ...
    <div class="absolute left-1/2 top-[10%] z-10 -translate-x-1/2">
      ...
      <button
        class="rounded-lg bg-rose-500 px-6 py-3 text-lg font-bold uppercase text-white shadow-[0_4px_15px_rgba(0,0,0,0.3)] transition duration-200 hover:scale-105 hover:bg-rose-700 disabled:cursor-not-allowed disabled:bg-zinc-500 disabled:opacity-70"
        @click="rollDice"
        :disabled="isRolling"
      >
        Кинути к20
